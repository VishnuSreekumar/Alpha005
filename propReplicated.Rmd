...
g <- ggplot(eqwin_df,aes(x=startwins+0.0025,y=winProps))+ geom_point(aes(size=Nsamp),color = currentpalette[6]) +scale_x_continuous(breaks=c(0,.005,.01,.015,.02,.025,.03,.035,.04,.045,.05),limits=c(0,.05)) + 
